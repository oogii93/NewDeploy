...
<div class="py-2 px-2">
    <form action="{{ route('admin.download1.csv') }}" method="POST" class="inline-block">
        ...
        <button class="ml-5 px-2 py-2 hover:bg-sky-600 rounded-xl">
            ...
            <span class="text-gray-600 hover:text-gray-800 font-semibold text-sm">確定ボタン</span>

            <p>lock button tegeed ene buttong darsanaar edit, update ajilahgui boloh@!!! tegeed darsanii daraa csv-g darj boldog bolgoh</p>
        </button>
