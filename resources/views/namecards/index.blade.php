                                ...
                                @foreach ($namecards as $product)
                                    <tr class="border-b border-gray-200 hover:bg-sky-50">
                                       ...
                                       @if($product->image_path)
                                            <img src="{{ asset($product->image) }}" alt="" class="w-40 h-32 object-cover">
                                        @else
                                            No image
                                        @endif
                                        </td>
                                        ...
                                        <td class="border border-slate-300 px-4 py-2">{{ $product->phone}}</td>
                                        <td class="border border-slate-300 px-4 py-2 hide-on-mobile">{{ $product->email }}
                                        </td>
