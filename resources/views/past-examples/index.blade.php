                ...
                <div class="container mx-auto ">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6  px-2 space-y-4 md:space-y-0">
                        ...
                        <div>
                            ...
                            <x-button
                                purpose="search"
                                href="{{ url('/past-examples-category') }}"
                        ...
                        {{-- Search Form --}}
                        <form action="{{ route('past-examples.index') }}" method="GET" class="w-full md:w-1/2">
                            <div class="relative">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse ($pastExamples as $index => $record)
                                        <tr class="hover:bg-sky-50 transition duration-200">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-4">
                                                    ...
                                                    {{-- Edit Button --}}
                                                    <a href="{{ route('past-examples.edit', $record->id) }}"
                                                    ...
                                                    {{-- Delete Button --}}
                                                    <form action="{{ route('past-examples.destroy', $record) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
                                                            type="submit"
