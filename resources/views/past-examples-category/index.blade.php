                ...
                <div class="container mx-auto ">
                    ...
                    <div class="bg-gradient-to-r from-sky-600 to-sky-800 rounded-t-xl shadow-lg mb-8">
                        <div class="p-6 text-center md:text-left">
                            <h1 class="text-4xl font-extrabold text-white mb-2">カテゴリ管理</h1>
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6  px-2 space-y-4 md:space-y-0">
                        ...
                        <div>
                            <x-button
                                purpose="search"
                                href="{{ url('/past-examples-category/create') }}"
                        ...
                        {{-- Search Form --}}
                        <form action="{{ route('past-examples-category.index') }}" method="GET" class="w-full md:w-1/2">
                            <div class="relative">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse ($categories as $index => $record)
                                        <tr class="hover:bg-sky-50 transition duration-200">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-4">
                                                    {{-- View Button --}}
                                                    {{-- <a href="{{ route('past-examples.show', $record->id) }}"
                                                    ...
                                                    {{-- Edit Button --}}
                                                    <a href="{{ route('past-examples-category.edit', $record->id) }}"
                                                    ...
                                                    {{-- Delete Button --}}
                                                    <form action="{{ route('past-examples-category.destroy', $record) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
                                                            type="submit"
