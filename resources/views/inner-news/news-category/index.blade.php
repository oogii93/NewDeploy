                ...
                <div class="container mx-auto ">
                    ...
                    <div class="bg-gradient-to-r from-sky-600 to-sky-800 rounded-t-xl shadow-lg mb-8">
                        <div class="p-6 text-center md:text-left">
                            <h1 class="text-4xl font-extrabold text-white mb-2">社内回覧カテゴリー管理</h1>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6  px-2 space-y-4 md:space-y-0">
                        ...
                        <div>
                            <x-button
                                purpose="search"
                                href="{{ route('inner-news.news-category.create') }}"
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                <thead class="bg-sky-50 border-b">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">名</th>
                                        ...
                                        <tr class="hover:bg-sky-50 transition duration-200">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-4">
                                                    ...
                                                    {{-- Edit Button --}}
                                                    <a href="{{ route('inner-news.news-category.edit', $category) }}"
                                                    ...
                                                    {{-- Delete Button --}}
                                                    <form action="{{ route('inner-news.news-category.destroy', $category) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
                                                            type="submit"
