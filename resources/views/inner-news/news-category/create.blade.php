        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gradient-to-r from-sky-600 to-sky-800 rounded-t-xl shadow-lg ">
                <div class="p-6 text-center md:text-left">
                    ...
                    <h3 class="text-xl font-semibold text-white mb-2">新規登録</h3>
                </div>
            </div>

            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('inner-news.news-category.store') }}" id="categoryForm">
                        @csrf
                        ...
                        <div class="mt-6">
                            <label class="block text-sm text-gray-700 mb-2 mt-1 px-2 font-semibold">内容</label>
                            <div id="fields-container" class="">
